class Map05 extends Map{
  ...
  public Map05(Entity jugador)
  {
    ...
    sheeps[2].setxy( 720, 490);
    buttons[0] = new StaticButton(490, 271);
    obstacles[0] = new Door(15, 80, 15, 80, 0, 0);
    obstacles[1] = new Door(1011, 475, 934, 404, 1, 0);
    obstacles[2] = new Door(491, 210, 389, 281, 1, 0);
    obstacles[3] = new Door(829, 443, 711, 513, 1, 1);
    obstacles[4] = new Door(571, 75, 571, 75, 1, 1);
